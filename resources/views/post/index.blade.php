    ...
    <nav class="bg-gray-900 border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://i.pinimg.com/564x/70/8c/4f/708c4fc218f00fa9a74ce36a368f949e.jpg" class="h-8" alt="Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Creepypasta</span>
            </a>
        </div>
    </nav>
    <div class="container mx-auto p-auto text-center mt-4">
        <a href="{{ route('post.create') }}" type="button"
            class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Add Story
        </a>
        ...
        <div class="flex flex-wrap justify-center mt-4">
            <!-- Card 1 -->
            {{-- kalau pake fopreach datanya harus ada --}}
            @forelse($post as $p)
            ...
            <div
                ...
                <div class="p-5">
                    ...
                    <a href="{{ route('post.edit', $p->id) }}"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-900 rounded-lg hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-400 dark:hover:bg-yellow-500 dark:focus:ring-yellow-600 mt-2">
                        Edit
            ...
            @empty
            <p class="text-5xl">no stories found</p>
